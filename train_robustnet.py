...
from utils.pipelines import PLTRobustNet
...
def train(config):
    ...
    def get_model(config):
        if config.model.name == 'MinkUNet34Robust':
    ...
    collation_source = CollateFNMultiSource() if isinstance(training_dataset, MultiSourceDataset) else CollateFNSingleSource()
    ...
    pl_module = PLTRobustNet(training_dataset=training_dataset,
