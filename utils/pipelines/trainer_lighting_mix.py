...
class PLTMixed(pl.core.LightningModule):
    r"""
    ...
    def training_step(self, batch, batch_idx):
        ...
        results_dict['training/sem_loss'] = sem_loss.item()
        results_dict['training/source_iou'] = np.mean(iou_tmp[present_labels])
        results_dict['training/lr'] = self.trainer.optimizers[0].param_groups[0]["lr"]
        results_dict['training/epoch'] = self.current_epoch
        results_dict['training/total_loss'] = total_loss.item()
