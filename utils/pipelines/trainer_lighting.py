...
class PLTTrainer(pl.core.LightningModule):
    ...
    def test_step(self, batch, batch_idx, dataloader_idx=0):
        ...
        out, feats = self.model(stensor, is_seg=False)
        feats = feats.F.cpu()
        sem_preds = out.F
        sem_labels = batch["sem_labels"].long()
        ...
        if self.save_predictions:
            ...
            for b in range(batch_size.int()):
                ...
                os.makedirs(os.path.join(self.save_folder, phase, 'labels'), exist_ok=True)
                ...
                o3d.io.write_point_cloud(os.path.join(self.save_folder, phase, 'labels', f'{s_idx}.ply'), pcd)
